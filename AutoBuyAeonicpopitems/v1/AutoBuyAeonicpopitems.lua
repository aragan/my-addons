...
local delay          = 8       -- الانتظار بين كل محاولة purchase_step
local price_increment = 10000  -- مقدار زيادة السعر كل مرّة نفشل فيها
...
local function purchase_group(group_name, mode)
    ...
    for i, item in ipairs(group) do
        -- If mode = 'helm', filter based on helm_names
