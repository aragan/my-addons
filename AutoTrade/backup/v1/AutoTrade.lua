...
windower.register_event('addon command', function(cmd, ...)
    ...
    -- إذا cmd كان اسم زون أو اختصارها
...
windower.register_event('prerender', function()
    ...
    if #item_names > 0 then
        ...
        -- بعد سحب الأيتمات، نستهدف الـ NPC ثم نعمل TradeNPC
        cmd_str = cmd_str .. ';@wait 1;input /targetnpc;@wait 2;' .. nm_data.command
    else
        -- لو ما فيه أيتمات في السطر (حالة نادرة) نستخدم السلوك القديم
        cmd_str = 'input /targetnpc;@wait 1;' .. nm_data.command
    end
