...
windower.register_event('prerender', function()
    ...
    if #item_names > 0 then
        ...
        cmd_str = 'setkey escape down; wait 0.1; setkey escape up; @wait 0.5;' .. cmd_str .. ';@wait 1;input /targetnpc;@wait 2;' .. nm_data.command .. ';@wait 3;setkey down down;wait 0.1;setkey down up; wait 0.1;setkey enter down; wait 0.1; setkey enter up'
    else
